	...
	<head>
		...
		<style type="text/css">
			* { font-family:"標楷體"; margin-left:auto; margin-right:auto;}
			h1 {color:rgb(23, 22, 21); font-size:60px;}
			h2 {color:#8d5f3d; font-size:40px;}
		</style>
		...
		function change2() {
  			...
  			document.getElementById("h2text").innerText = "Rei - Chien , Wang";
		}
		</script>
	...
	<body>
		...
		<table width = "70%">
			<tr>
				...
				<td>
					<h1>王睿謙</h1>
					<h2 id="h2text">Rei - Chien , Wang</h2>
				</td>
			</tr>
		</table>
		<table width="70%" border="1">
			<tr>
				<td>
					網頁：<a href="https://horny-dragon.blogspot.com/2015/11/adventure-time-s07e07-everything-stays.html"target="_blank">請點擊</a><br>
					Tel: :P<br>
					E-Mail: reindio4444@gmail.com<br>
				</td>
